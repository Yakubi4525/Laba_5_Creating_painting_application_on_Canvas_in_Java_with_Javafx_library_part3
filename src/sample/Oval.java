...
public class Oval extends  TFigure {
    // Поле класса
    ...
    public Oval(){
        super(new Random().nextDouble() * 634.0,new Random().nextDouble() * 400,Color.rgb(new Random().nextInt(256), new Random().nextInt(256), new Random().nextInt(256)));
        this.size = (new Random().nextDouble() * (200.0) + 30);

    }

    public Oval(double show_x, double show_y, double size, Color color){
